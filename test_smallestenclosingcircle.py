        ...
        for _ in range(TRIALS):
            ...
            for _ in range(CHECKS):
                ...
                self.assertAlmostEqual(
                    scaled[2], reference[2] * abs(scale), delta=_EPSILON
                )
    ...
    for i in range(len(points)):
        ...
        for j in range(i + 1, len(points)):
            ...
            if (result is None or c[2] < result[2]) and all(
                smallestenclosingcircle.is_in_circle(c, r) for r in points
            ):
                result = c
        ...
        for j in range(i + 1, len(points)):
            ...
            for k in range(j + 1, len(points)):
                ...
                if (
                    ...
                    and all(smallestenclosingcircle.is_in_circle(c, s) for s in points)
                ):
                    result = c
